...
#define REGISTER_THORN(x, y, tex, camera, vec, polygons) new Thorn(static_cast<float>(x), static_cast<float>(y), CELL_WIDTH * 0.9, CELL_HEIGHT * 0.9, tex, 1, camera, vec, polygons)
#define REGISTER_THORN_HALF(x, y, tex, camera, vec, polygons) new Thorn(static_cast<float>(x), static_cast<float>(y), CELL_WIDTH * 0.9, CELL_HEIGHT / 2 * 0.9, tex, 1, camera, vec, polygons)
#define REGISTER_THORN_UP(x, y, tex, camera, polygons) REGISTER_THORN(static_cast<float>(x), static_cast<float>(y) - 1, tex, camera, Thorn::Vec::UP, polygons)
#define REGISTER_THORN_UP_HALF(x, y, tex, camera, polygons) REGISTER_THORN_HALF(static_cast<float>(x), static_cast<float>(y) - 1, tex, camera, Thorn::Vec::UP, polygons)
#define REGISTER_THORN_DOWN(x, y, tex, camera, polygons) REGISTER_THORN(static_cast<float>(x), static_cast<float>(y) + 1, tex, camera, Thorn::Vec::DOWN, polygons)
#define REGISTER_THORN_DOWN_HALF(x, y, tex, camera, polygons) REGISTER_THORN_HALF(static_cast<float>(x), static_cast<float>(y) + 1, tex, camera, Thorn::Vec::DOWN, polygons)
#define REGISTER_THORN_LEFT(x, y, tex, camera, polygons) REGISTER_THORN(static_cast<float>(x) + 1, static_cast<float>(y), tex, camera, Thorn::Vec::LEFT, polygons)
